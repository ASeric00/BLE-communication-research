...
const char passkey[] = "123456"; // Set a static 6-digit passkey
...
void setup() {
  ...
  // Configure passkey security
  BLE.setSecurityPasskey(passkey); // Set the passkey
  BLE.setSecurityAuthenticationMode(BLESecurityMode::BLE_SM_PIN); // Require passkey entry
  ...
  BLE.setDeviceName("Nano33BLE_Passkey");
  BLE.setLocalName("Nano33BLE_Passkey");
  BLE.advertise();

  Serial.println("BLE service is now advertising with passkey.");
}
